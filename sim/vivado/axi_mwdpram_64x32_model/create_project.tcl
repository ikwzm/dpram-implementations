...
set project_name            "axi_mwdpram_64x32_model"
set device_parts            "xc7z010clg400-1"
set test_bench              "AXI_MWDPRAM_64x32_R4W4RF_MODEL_TEST_BENCH"
set scenario_path           [file join ".." ".." ".." "src" "test" "scenarios" ]
set scenario_file           [file join $scenario_path "axi_mwdpram_64x32_r4w4rf_model_test_bench.snr" ]
#
# Create project
#
...
set_property "top" "AXI_MWDPRAM_64X32_R4W4RF_MODEL" $obj
#
