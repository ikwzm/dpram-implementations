...
proc create_root_design { parentCell } {
  ...
  #
  set AXI_DPRAM_64x32_0 [ create_bd_cell -type ip -vlnv ikwzm:PIPEWORK:AXI_DPRAM_MODEL_0:1.1 AXI_DPRAM_64X32_0 ]
  ...
  set_property -dict [ list CONFIG.RAM_NUM         {4} ] $AXI_DPRAM_64x32_0
  #
