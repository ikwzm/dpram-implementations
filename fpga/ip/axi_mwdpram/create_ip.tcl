...
#
set project_name            "axi_mwdpram"
set ip_name                 "AXI_MWDPRAM"
set ip_version              "1.1"
set ip_core_revision        1
set ip_vendor_name          "ikwzm"
set ip_library_name         "PIPEWORK"

set ip_root_directory       [file join [file dirname [info script]] ".." "axi_mwdpram_$ip_version"]
...
set_property description   "AXI Mixed Width DPRAM"  [ipx::current_core]
#
# Associate Clock
#
