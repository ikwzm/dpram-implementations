...
#
set project_name            "axi_dpram_model_0"
set ip_name                 "AXI_DPRAM_MODEL_0"
set ip_version              "1.1"
set ip_core_revision        1
set ip_vendor_name          "ikwzm"
set ip_library_name         "PIPEWORK"

set ip_root_directory       [file join [file dirname [info script]] ".." "axi_dpram_model_0_$ip_version"]
...
set_property description   "AXI DPRAM TYPE=MODEL_0" [ipx::current_core]
#
# Associate Clock
#
