...
proc create_root_design { parentCell } {
  ...
  # 
  # Create instance: AXI_MWDPRAM and set properties
  #
  set AXI_MWDPRAM_64x32_0 [ create_bd_cell -type ip -vlnv ikwzm:PIPEWORK:AXI_MWDPRAM:1.1 AXI_MWDPRAM_64X32_0 ]
  set_property -dict [ list CONFIG.C_ADDR_WIDTH   {32} ] $AXI_MWDPRAM_64x32_0
  set_property -dict [ list CONFIG.C_DATA_WIDTH   {32} ] $AXI_MWDPRAM_64x32_0
  set_property -dict [ list CONFIG.C_ID_WIDTH      {5} ] $AXI_MWDPRAM_64x32_0
  set_property -dict [ list CONFIG.RAM_ADDR_WIDTH  {8} ] $AXI_MWDPRAM_64x32_0
  set_property -dict [ list CONFIG.RAM_RN          {4} ] $AXI_MWDPRAM_64x32_0
  set_property -dict [ list CONFIG.RAM_WN          {4} ] $AXI_MWDPRAM_64x32_0
  set_property -dict [ list CONFIG.WRITE_FIRST     {0} ] $AXI_MWDPRAM_64x32_0
  #
  ...
  connect_bd_net -net SYS_CLK0   [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]           \
                                 ...
                                 [get_bd_pins AXI_MWDPRAM_64x32_0/ACLK]    
  ...
  connect_bd_net -net SYS_RESETN [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
                                 ...
                                 [get_bd_pins AXI_MWDPRAM_64x32_0/ARESETn]     
  #
  # Connect Interfaces
  #
  ...
  connect_bd_intf_net -intf_net AXI_DPRAM0_CSR -boundary_type upper [get_bd_intf_pins axi_interconnect_csr/M00_AXI] [get_bd_intf_pins AXI_MWDPRAM_64x32_0/C]
  #
  # Assign Address Map
  #
  create_bd_addr_seg -range 0x1000      -offset  0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs AXI_MWDPRAM_64x32_0/C/reg0] SEG_AXI_MWDPRAM_64x32_0_Reg
  #
