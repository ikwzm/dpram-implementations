...
set ip_name                 "AXI_DPRAM_64x32_MODEL"
set ip_version              "1.1"
set ip_core_revision        1
set ip_vendor_name          "ikwzm"
set ip_library_name         "PIPEWORK"

set ip_root_directory       [file join [file dirname [info script]] "axi_dpram_64x32_model_$ip_version"]
...
set_property description   "AXI DPRAM 64x32 TYPE=MODEL"  [ipx::current_core]
#
# Associate Clock
#
