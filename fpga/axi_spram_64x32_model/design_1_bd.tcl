...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SYS_CLK0   [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]           \
                                 ...
                                 [get_bd_pins AXI_SPRAM_64x32_0/ACLK]    
  ...
  connect_bd_net -net SYS_RESETN [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
                                 ...
                                 [get_bd_pins AXI_SPRAM_64x32_0/ARESETn]     
  #
  # Connect Interfaces
  #
  ...
  connect_bd_intf_net -intf_net AXI_SPRAM0_CSR -boundary_type upper [get_bd_intf_pins axi_interconnect_csr/M00_AXI] [get_bd_intf_pins AXI_SPRAM_64x32_0/C]
  #
  # Assign Address Map
  #
  create_bd_addr_seg -range 0x1000      -offset  0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs AXI_SPRAM_64x32_0/C/reg0] SEG_AXI_SPRAM_64x32_0_Reg
  #
